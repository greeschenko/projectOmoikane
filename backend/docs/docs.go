...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/internal/trash": {
            ...
            "delete": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Only empty this owned entity type",
                        "name": "entity",
                        "in": "query"
                    }
                ],
        ...
        "/internal/trash/{entity}/{id}": {
            "delete": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Owned entity type (page, user, post, media, contact, message, tag, category)",
                        "name": "entity",
                        "in": "path",
                        "required": true
                    },
        ...
        "/internal/trash/{entity}/{id}/restore": {
            "post": {
