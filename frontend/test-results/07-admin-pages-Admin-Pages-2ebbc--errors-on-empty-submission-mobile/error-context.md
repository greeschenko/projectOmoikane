...
- Name: 07-admin-pages.spec.ts >> Admin Pages >> Page creation form >> shows validation errors on empty submission
- Location: e2e/07-admin-pages.spec.ts:60:9
...
Call log:
  - waiting for getByRole('button', { name: /save|create|submit/i })
