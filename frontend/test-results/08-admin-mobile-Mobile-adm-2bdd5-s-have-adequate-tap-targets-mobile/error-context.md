...
- Name: 08-admin-mobile.spec.ts >> Mobile admin responsive layout >> All tests in this file run only on mobile >> form fields have adequate tap targets
- Location: e2e/08-admin-mobile.spec.ts:61:9
